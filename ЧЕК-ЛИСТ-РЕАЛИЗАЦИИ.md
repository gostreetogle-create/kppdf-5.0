...
**Файл:** `src/app/api/import/cad/route.ts` (новая)
**Статус:** 🔴 НЕ РЕАЛИЗОВАНО. Нужно создать POST /api/import/cad с Zod-валидацией.
**Назначено:** MiMo
...
| Фаза 6: Интеграции | 🟡 2/3 | 6.1 — CAD import (MiMo) |
| **ИТОГО** | **✅ 32/33 (97%)** | **1 задача (CAD import — MiMo)** |
