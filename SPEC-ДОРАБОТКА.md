...
Сделать сегодня:
- [ ] **Обновить Prisma schema**: DocumentTemplate, DocBlock, DocTextColumn, TableTemplate (MiMo создал, проверить)
- [ ] **API для шаблонов документов**: CRUD + clone + preview (MiMo)
- [ ] **API для шаблонов таблиц**: CRUD (MiMo создал ✅)
- [ ] **Добавить поля в Proposal**: templateId, discountPercent, vatRate

### Этап 2 — Визуальный редактор шаблонов документов (MiMo + Я)

- [ ] Компонент A4 Canvas (kp-doc-canvas) — Next.js версия
- [ ] Drag-and-drop блоков (dnd-kit библиотека)
- [ ] Редактор текстового блока (rich text с колонками)
- [ ] Редактор табличного блока (выбор шаблона)
- [ ] Редактор разделителя
- [ ] Загрузка фоновых изображений + drag-reorder + opacity
- [ ] Undo/Redo стек
- [ ] Автосохранение в localStorage
- [ ] Предпросмотр документа
- [ ] Страница списка + редактор

### Этап 3 — Доработка Proposal Showcase (Я)

- [ ] Заменить правую панель на A4 Canvas с блоками из шаблона
- [ ] Двойной клик по таблице → диалог редактирования
- [ ] Глобальная скидка + НДС
- [ ] Персональная наценка клиента
- [ ] Автовыбор шаблона
- [ ] Скачать PDF из canvas
...
- [ ] Все API протестированы (браузер / curl)
- [ ] Нет неиспользуемых импортов
- [ ] Нет закомментированного кода
- [ ] Обработка ошибок (try/catch, error state)
- [ ] Loading state (skeleton / spinner)
- [ ] Empty state (нет данных)
- [ ] Адаптивность (mobile/tablet/desktop)
- [ ] Предусмотрены edge cases (0 товаров, удаление последнего и т.д.)
- [ ] Undo/Redo (где применимо)
- [ ] Draft autosave (где применимо)
