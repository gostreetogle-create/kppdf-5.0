#!/usr/bin/env bash
# ============================================================
# KPPDF v5.0 — deploy.sh (Synology) [ИСТОРИЧЕСКИЙ]
# ============================================================
# ВНИМАНИЕ: Этот скрипт для Synology NAS (192.168.1.100).
# Текущий деплой выполняется на Ubuntu (192.168.1.46) через deploy-v5.sh.
# ============================================================
