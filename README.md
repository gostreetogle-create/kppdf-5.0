...
> 🆕 **Проект прошёл совместный AI-аудит** (cycles 39–40 завершены, cycles 41–50 запланированы). Полный отчёт для внешнего аудитора: [`docs/analysis/AUDIT-REVIEW.md`](./docs/analysis/AUDIT-REVIEW.md) — описание стека, реальный status, карта изменений, известные ограничения, инструкция для ревьюера.
...
Полный чек-лист из 24 задач в [`docs/domain/BUSINESS-LOGIC.md`](./docs/domain/BUSINESS-LOGIC.md):
...
👉 [`docs/operations/DEPLOY-SYNO.md`](./docs/operations/DEPLOY-SYNO.md)
...
## 📊 Параллельные задачи и статус

Чек-листы крупных задач и журнал параллельных работ:
- [`docs/tasks/`](./docs/tasks/) — чек-листы и статус
