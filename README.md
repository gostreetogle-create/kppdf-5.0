...
> 🆕 **Проект прошёл совместный AI-аудит** (cycles 39–40 завершены, cycles 41–50 запланированы). Полный отчёт для внешнего аудитора: [`AUDIT-REVIEW.md`](./AUDIT-REVIEW.md) — описание стека, реальный status, карта изменений, известные ограничения, инструкция для ревьюера.
