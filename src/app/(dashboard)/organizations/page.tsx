  ...
  return (
    <CrudPage<Organization>
      ...
      columns={[
        ...
        { key: 'isActive', label: 'Статус', render: (item) => <span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${item.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`}>{item.isActive ? 'Активна' : 'Неактивна'}</span> },
      ]}
